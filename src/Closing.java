...
/**
 * This class implements a closing operation by rotational morphological processing
 *
...
public class Closing {
	...
	String msg = "Closing... " + param.CurImg() + "/" + param.TotalImg();
	IJ.showStatus(msg);
    ...
    private void DoClosing(BaseParameter param) {
	Dilation(param);
	Erosion(param);
    }
