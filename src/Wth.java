...
/**
 * This class implements a white top-hat operation by rotational morphological processing
 *
...
public class Wth {
	...
	String msg = "White Top-hat... " + param.CurImg() + "/" + param.TotalImg();
	IJ.showStatus(msg);
	...
	for (int y=0; y<param.ImgSizeY; y++) {
	    for (int x=0; x<param.ImgSizeX; x++) {
		DiffImg[y][x] = param.InImg[y][x] - OpenImg[y][x];
		if(DiffImg[y][x] < 0)
		    DiffImg[y][x] = 0;
	    }
	}
