...
/**
 * This class implements a morphological contrast enhacement (Type 1) by rotational morphological processing
 *
...
public class Enhance {
	...
	String msg = "Enhance - Type 1... " + param.CurImg() + "/" + param.TotalImg();
	IJ.showStatus(msg);
    ...
    private void Differential(BaseParameter param) {
	for (int y=0; y<param.ImgSizeY; y++) {
	    for (int x=0; x<param.ImgSizeX; x++) {
		DiffImg[y][x] = param.InImg[y][x] - param.OutImg[y][x];
	    }
	}
